...
<div class="parallax-container" id="title-slide">
	<div class="parallax"><img src="<spring:url value="/img/football_remotes_banner_1140x380-01f2fed9f084018b2efe1014ead7cdb6a733ba2b.jpg" />"></div>
	<div class="box">
		<div class="section">
		</div>
		<div class="row center">
			<div class="card blue-grey darken-2 hoverable">
				<div class="card-content white-text">
					<h1 class="header center">The Sky Accessories Store</h1>
				</div>
			</div>
		</div>
	</div>
