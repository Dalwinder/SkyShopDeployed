...
public class CustomerImpl {
    ...
    public CustomerImpl(String title, String forename, String surname, Address address, Department department, String mobileNumber, String landlineNumber, String login, Password password, boolean securityLevel){
        this.title = title;
